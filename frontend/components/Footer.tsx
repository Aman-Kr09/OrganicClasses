...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white" role="contentinfo">
        ...
        <div className="py-12 sm:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          >
            <div className="flex items-center space-x-2 mb-4 sm:mb-6">
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold">Organic Classes</h3>
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 flex flex-col space-y-2 sm:space-y-3 z-40">
        {/* WhatsApp Button */}
        <motion.a
          href="https://wa.me/919876543210"
          target="_blank"
          rel="noopener noreferrer"
          className="bg-green-500 hover:bg-green-600 text-white p-3 sm:p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-200"
        ...
        <motion.a
          href="tel:+919876543210"
          className="bg-primary-500 hover:bg-primary-600 text-white p-3 sm:p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-200"
